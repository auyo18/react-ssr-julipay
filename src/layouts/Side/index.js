...
import {setOneRandomArticle} from "./store/actions"
import './index.scss'
    ...
    return (
      <div className="side">
        ...
        <div className="random"
             style={{backgroundImage: `url(${this.props.oneRandomArticle && this.props.oneRandomArticle.length && this.props.oneRandomArticle[0].thumbnail})`}}>
          <div className="mask"/>
          <div className="bottom">
            <p className="title">
              {this.props.oneRandomArticle && this.props.oneRandomArticle.length && this.props.oneRandomArticle[0].title}
            </p>
            <p>
              <span className="badge">随机一文</span>
              <span className="switch" onClick={this.props.setOneRandomArticle}>↻</span>
            </p>
          </div>
        </div>
        <div className="polymerization">
          ...
          <div className="article-wrapper">
            {
              this.props.polymerizationList && this.props.polymerizationList.length && this.props.polymerizationList.map(article => (
        ...
        <div className="recommend">
          ...
          <div className="article-wrapper">
            {
              this.props.recommendList && this.props.recommendList.length && this.props.recommendList.map((article, index) => (
