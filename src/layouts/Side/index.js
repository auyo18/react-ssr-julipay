    ...
    return (
      <div className="side">
        ...
        <div className="random">
          <div className="image"
               style={{backgroundImage: `url(${this.props.oneRandomArticle && this.props.oneRandomArticle.length > 0 && this.props.oneRandomArticle[0].thumbnail})`}} />
          <div className="mask" />
          <div className="bottom">
            <p className="title">
              {this.props.oneRandomArticle && this.props.oneRandomArticle.length > 0 && this.props.oneRandomArticle[0].title}
            </p>
            <p>
